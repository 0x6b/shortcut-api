...
/// EpicSlim : EpicSlim represents the same resource as an Epic but is more light-weight, including
/// all Epic fields except the comments array. The description string can be optionally included.
/// Use the [Get Epic](#Get-Epic) endpoint to fetch the unabridged payload for an Epic.
...
impl EpicSlim {
    /// EpicSlim represents the same resource as an Epic but is more light-weight, including all
    /// Epic fields except the comments array. The description string can be optionally included.
    /// Use the [Get Epic](#Get-Epic) endpoint to fetch the unabridged payload for an Epic.
    pub fn new(
        app_url: String,
        archived: bool,

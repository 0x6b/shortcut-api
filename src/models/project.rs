...
impl Project {
    ...
    pub fn new(app_url: String, description: Option<String>, archived: bool, entity_type: String, days_to_thermometer: i64, color: Option<String>, workflow_id: i64, name: String, start_time: String, updated_at: Option<String>, follower_ids: Vec<uuid::Uuid>, external_id: Option<String>, id: i64, show_thermometer: bool, team_id: i64, iteration_length: i64, abbreviation: Option<String>, stats: crate::models::ProjectStats, created_at: Option<String>) -> Project {
        Project {
            app_url,
            description,
            archived,

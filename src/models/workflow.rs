...
/// Workflow : Workflow is the array of defined Workflow States. Workflow can be queried using the
...
impl Workflow {
    /// Workflow is the array of defined Workflow States. Workflow can be queried using the API but
    /// must be updated in the Shortcut UI.
    pub fn new(
        description: String,
        entity_type: String,
        project_ids: Vec<f64>,

...
impl Story {
    ...
    pub fn new(app_url: String, description: String, archived: bool, started: bool, story_links: Vec<crate::models::TypedStoryLink>, entity_type: String, labels: Vec<crate::models::LabelSlim>, mention_ids: Vec<uuid::Uuid>, member_mention_ids: Vec<uuid::Uuid>, story_type: String, linked_files: Vec<crate::models::LinkedFile>, workflow_id: i64, completed_at_override: Option<String>, started_at: Option<String>, completed_at: Option<String>, name: String, global_id: String, completed: bool, comments: Vec<crate::models::StoryComment>, blocker: bool, branches: Vec<crate::models::Branch>, epic_id: Option<i64>, story_template_id: Option<uuid::Uuid>, external_links: Vec<String>, previous_iteration_ids: Vec<i64>, requested_by_id: uuid::Uuid, iteration_id: Option<i64>, tasks: Vec<crate::models::Task>, label_ids: Vec<i64>, started_at_override: Option<String>, group_id: Option<uuid::Uuid>, workflow_state_id: i64, updated_at: Option<String>, pull_requests: Vec<crate::models::PullRequest>, group_mention_ids: Vec<uuid::Uuid>, follower_ids: Vec<uuid::Uuid>, owner_ids: Vec<uuid::Uuid>, external_id: Option<String>, id: i64, estimate: Option<i64>, commits: Vec<crate::models::Commit>, files: Vec<crate::models::UploadedFile>, position: i64, blocked: bool, project_id: Option<i64>, deadline: Option<String>, stats: crate::models::StoryStats, created_at: String, moved_at: Option<String>) -> Story {
        Story {
            app_url,
            description,
            archived,

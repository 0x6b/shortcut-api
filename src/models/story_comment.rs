...
impl StoryComment {
    ...
    pub fn new(app_url: String, entity_type: String, deleted: bool, story_id: i64, mention_ids: Vec<uuid::Uuid>, author_id: Option<uuid::Uuid>, member_mention_ids: Vec<uuid::Uuid>, updated_at: Option<String>, group_mention_ids: Vec<uuid::Uuid>, external_id: Option<String>, id: i64, position: i64, reactions: Vec<crate::models::StoryReaction>, created_at: String, text: Option<String>) -> StoryComment {
        StoryComment {
            app_url,
            entity_type,
            deleted,

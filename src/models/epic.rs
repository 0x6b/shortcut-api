...
impl Epic {
    ...
    pub fn new(app_url: String, description: String, archived: bool, started: bool, entity_type: String, labels: Vec<crate::models::LabelSlim>, mention_ids: Vec<uuid::Uuid>, member_mention_ids: Vec<uuid::Uuid>, associated_groups: Vec<crate::models::EpicAssociatedGroup>, project_ids: Vec<i64>, stories_without_projects: i64, completed_at_override: Option<String>, productboard_plugin_id: Option<uuid::Uuid>, started_at: Option<String>, completed_at: Option<String>, name: String, global_id: String, completed: bool, comments: Vec<crate::models::ThreadedComment>, productboard_url: Option<String>, planned_start_date: Option<String>, state: String, milestone_id: Option<i64>, requested_by_id: uuid::Uuid, epic_state_id: i64, label_ids: Vec<i64>, started_at_override: Option<String>, group_id: Option<uuid::Uuid>, updated_at: Option<String>, group_mention_ids: Vec<uuid::Uuid>, productboard_id: Option<uuid::Uuid>, follower_ids: Vec<uuid::Uuid>, owner_ids: Vec<uuid::Uuid>, external_id: Option<String>, id: i64, position: i64, productboard_name: Option<String>, deadline: Option<String>, stats: crate::models::EpicStats, created_at: Option<String>) -> Epic {
        Epic {
            app_url,
            description,
            archived,

...
impl StoryLink {
    ...
    pub fn new(entity_type: String, id: i64, subject_id: i64, subject_workflow_state_id: i64, verb: String, object_id: i64, created_at: String, updated_at: String) -> StoryLink {
        StoryLink {
            entity_type,
            id,
            subject_id,

...
impl Branch {
    ...
    pub fn new(entity_type: String, deleted: bool, name: String, persistent: bool, updated_at: Option<String>, pull_requests: Vec<crate::models::PullRequest>, merged_branch_ids: Vec<i64>, id: Option<i64>, url: String, repository_id: i64, created_at: Option<String>) -> Branch {
        Branch {
            entity_type,
            deleted,
            name,

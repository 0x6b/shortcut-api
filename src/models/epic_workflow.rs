...
/// EpicWorkflow : Epic Workflow is the array of defined Epic States. Epic Workflow can be queried
/// using the API but must be updated in the Shortcut UI.
...
impl EpicWorkflow {
    /// Epic Workflow is the array of defined Epic States. Epic Workflow can be queried using the
    /// API but must be updated in the Shortcut UI.
    pub fn new(
        entity_type: String,
        id: i64,
        created_at: String,
        updated_at: String,
        default_epic_state_id: i64,
        epic_states: Vec<crate::models::EpicState>,
    ) -> EpicWorkflow {
        EpicWorkflow {
            entity_type,
            id,

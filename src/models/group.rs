...
impl Group {
    /// A Group.
    pub fn new(app_url: String, description: String, archived: bool, entity_type: String, color: Option<String>, num_stories_started: i64, mention_name: String, name: String, global_id: String, color_key: Option<ColorKey>, num_stories: i64, num_epics_started: i64, num_stories_backlog: i64, id: uuid::Uuid, display_icon: crate::models::Icon, member_ids: Vec<uuid::Uuid>, workflow_ids: Vec<i64>) -> Group {
        Group {
            app_url,
            description,
            archived,

...
pub struct EpicSearchResults {
    ...
    #[serde(rename = "data")]
    pub data: Vec<crate::models::EpicSearchResult>,
...
impl EpicSearchResults {
    /// The results of the Epic search query.
    pub fn new(total: i64, data: Vec<crate::models::EpicSearchResult>, next: Option<String>) -> EpicSearchResults {
        EpicSearchResults {
            total,
            data,
            next,

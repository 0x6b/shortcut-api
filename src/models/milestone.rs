...
/// Milestone : A Milestone is a collection of Epics that represent a release or some other large
...
impl Milestone {
    /// A Milestone is a collection of Epics that represent a release or some other large initiative

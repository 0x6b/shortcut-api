...
impl ThreadedComment {
    ...
    pub fn new(app_url: String, entity_type: String, deleted: bool, mention_ids: Vec<uuid::Uuid>, author_id: uuid::Uuid, member_mention_ids: Vec<uuid::Uuid>, comments: Vec<crate::models::ThreadedComment>, updated_at: String, group_mention_ids: Vec<uuid::Uuid>, external_id: Option<String>, id: i64, created_at: String, text: String) -> ThreadedComment {
        ThreadedComment {
            app_url,
            entity_type,
            deleted,

...
impl Task {
    /// A Task on a Story.
    pub fn new(description: String, entity_type: String, story_id: i64, mention_ids: Vec<uuid::Uuid>, member_mention_ids: Vec<uuid::Uuid>, completed_at: Option<String>, updated_at: Option<String>, group_mention_ids: Vec<uuid::Uuid>, owner_ids: Vec<uuid::Uuid>, external_id: Option<String>, id: i64, position: i64, complete: bool, created_at: String) -> Task {
        Task {
            description,
            entity_type,
            story_id,

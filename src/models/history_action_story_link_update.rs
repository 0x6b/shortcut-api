...
impl HistoryActionStoryLinkUpdate {
    ...
    pub fn new(id: i64, entity_type: String, action: Action, verb: Verb, subject_id: i64, object_id: i64, changes: crate::models::HistoryChangesStoryLink) -> HistoryActionStoryLinkUpdate {

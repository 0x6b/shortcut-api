...
/// LinkedFile : Linked files are stored on a third-party website and linked to one or more Stories.
/// Shortcut currently supports linking files from Google Drive, Dropbox, Box, and by URL.
...
impl LinkedFile {
    /// Linked files are stored on a third-party website and linked to one or more Stories. Shortcut
    /// currently supports linking files from Google Drive, Dropbox, Box, and by URL.
    pub fn new(

...
impl IterationSlim {
    ...
    pub fn new(app_url: String, entity_type: String, labels: Vec<crate::models::Label>, mention_ids: Vec<uuid::Uuid>, member_mention_ids: Vec<uuid::Uuid>, associated_groups: Vec<crate::models::IterationAssociatedGroup>, name: String, global_id: String, label_ids: Vec<i64>, updated_at: String, group_mention_ids: Vec<uuid::Uuid>, end_date: String, follower_ids: Vec<uuid::Uuid>, group_ids: Vec<uuid::Uuid>, start_date: String, status: String, id: i64, stats: crate::models::IterationStats, created_at: String) -> IterationSlim {
        IterationSlim {
            app_url,
            entity_type,
            labels,

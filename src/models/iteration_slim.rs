...
/// IterationSlim : IterationSlim represents the same resource as an Iteration, but is more
/// light-weight. Use the [Get Iteration](#Get-Iteration) endpoint to fetch the unabridged payload
/// for an Iteration.
...
pub struct IterationSlim {
    ...
    /// An array containing Group IDs and Group-owned story counts for the Iteration's associated
    /// groups.
...
impl IterationSlim {
    /// IterationSlim represents the same resource as an Iteration, but is more light-weight. Use
    /// the [Get Iteration](#Get-Iteration) endpoint to fetch the unabridged payload for an
    /// Iteration.
    pub fn new(
        app_url: String,
        entity_type: String,
        ...
        associated_groups: Vec<crate::models::IterationAssociatedGroup>,
        name: String,
        global_id: String,
        label_ids: Vec<i64>,
        updated_at: String,
        ...
        status: String,
        id: i64,
        stats: crate::models::IterationStats,
        created_at: String,
    ) -> IterationSlim {
        IterationSlim {
            app_url,

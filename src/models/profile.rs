...
impl Profile {
    ...
    pub fn new(entity_type: String, deactivated: bool, mention_name: String, name: Option<String>, gravatar_hash: Option<String>, id: uuid::Uuid, display_icon: crate::models::Icon, is_owner: bool, email_address: Option<String>) -> Profile {
        Profile {
            entity_type,
            deactivated,

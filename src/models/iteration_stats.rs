...
impl IterationStats {
    ...
    pub fn new(num_points_done: i64, num_related_documents: i64, num_stories_unstarted: i64, num_points_started: i64, num_points_unstarted: i64, num_stories_started: i64, num_stories_unestimated: i64, num_stories_backlog: i64, num_points_backlog: i64, num_points: i64, num_stories_done: i64) -> IterationStats {
        IterationStats {
            num_points_done,

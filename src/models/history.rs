...
pub struct History {
    ...
    /// An array of objects affected by the change. Reference objects provide basic information for
    /// the entities reference in the history actions. Some have specific fields, but they always
    /// contain an id, entity_type, and a name.

...
impl UploadedFile {
    ...
    pub fn new(description: Option<String>, entity_type: String, story_ids: Vec<i64>, mention_ids: Vec<uuid::Uuid>, member_mention_ids: Vec<uuid::Uuid>, name: String, thumbnail_url: Option<String>, size: i64, uploader_id: uuid::Uuid, content_type: String, updated_at: Option<String>, filename: String, group_mention_ids: Vec<uuid::Uuid>, external_id: Option<String>, id: i64, url: Option<String>, created_at: String) -> UploadedFile {
        UploadedFile {
            description,
            entity_type,
            story_ids,

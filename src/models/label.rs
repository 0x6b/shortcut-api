...
impl Label {
    ...
    pub fn new(app_url: String, description: Option<String>, archived: bool, entity_type: String, color: Option<String>, name: String, global_id: String, updated_at: Option<String>, external_id: Option<String>, id: i64, created_at: Option<String>) -> Label {
        Label {
            app_url,
            description,
            archived,

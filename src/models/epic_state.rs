...
impl EpicState {
    ...
    pub fn new(description: String, entity_type: String, name: String, global_id: String, r#type: String, updated_at: String, id: i64, position: i64, created_at: String) -> EpicState {
        EpicState {
            description,
            entity_type,
            color: None,

...
/// MilestoneSearchResult : A Milestone in search results. This is typed differently from Milestone
/// because the details=slim search argument will omit some fields.
...
pub struct MilestoneSearchResult {
    ...
    #[serde(rename = "id")]
    pub id: i64,
    /// A number representing the position of the Milestone in relation to every other Milestone
...
impl MilestoneSearchResult {
    /// A Milestone in search results. This is typed differently from Milestone because the
    ...
    pub fn new(
        ...
        id: i64,
        position: i64,
        stats: crate::models::MilestoneStats,
        created_at: String,

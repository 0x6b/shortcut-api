...
/// EpicSearchResult : An Epic in search results. This is typed differently from Epic because the
...
impl EpicSearchResult {
    /// An Epic in search results. This is typed differently from Epic because the details=slim
